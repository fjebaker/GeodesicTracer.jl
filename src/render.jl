"""
    $(TYPEDSIGNATURES)
"""
@inline function render!(row, α_range, β, d, s::BHSetup, valuefunc::ValueFunction; solver=Tsit5())
...
"""
function render(d, s::BHSetup; valuefunc = geometry, kwargs...)
...
"""
function render!(image, d, s::BHSetup, valuefunc::ValueFunction; kwargs...)
